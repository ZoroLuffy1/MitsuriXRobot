            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/NezukoXupdates/4"
                            ),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/NezukoXupdates/3"
                            ),
                        ],
                    ]
                ),
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + f"\n\n [✦Updates](https://t.me/NezukoXupdates) | [✦Support](https://t.me/NezukoXSupport)\n\n"
            + "╘══「 by [Hɪʀᴏ Kᴜɴ](https://t.me/Hiro_Kun_14) 」\n",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
        ...
        update.effective_message.reply_text(
            (
                (
                    ...
                    + f"\n\n [✦Updates](https://t.me/NezukoXupdates) | [✦Support](https://t.me/{SUPPORT_CHAT})\n\n"
                )
                + "╘══「 by [Hɪʀᴏ Kᴜɴ](https://t.me/Hiro_Kun_14) 」\n"
            ),
            parse_mode=ParseMode.MARKDOWN,
