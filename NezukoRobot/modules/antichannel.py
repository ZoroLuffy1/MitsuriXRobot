...
from NezukoRobot.modules.helper_funcs.decorators import Nezukocmd, Nezukomsg
from NezukoRobot.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from NezukoRobot.modules.sql.antichannel_sql import (
    antichannel_status,
    disable_antichannel,
    enable_antichannel,
)
...
@Nezukocmd(command="antichannelmode", group=100)
...
@Nezukomsg(Filters.chat_type.groups, group=110)
