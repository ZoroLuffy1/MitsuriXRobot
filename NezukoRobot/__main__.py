...
def Nezuko_about_callback(update, context):
    query = update.callback_query
    chat = update.effective_chat
    if query.data == "Nezuko_":
        query.message.edit_text(
    ...
    elif query.data == "Nezuko_support":
        query.message.edit_text(
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        Nezuko_about_callback, pattern=r"Nezuko_", run_async=True
    )
